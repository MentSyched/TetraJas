...
public class UsuarioController {
	...
	public Usuario addUsuario(@RequestParam String nombre, String contraseña){
		Usuario p=pp.save( new Usuario(nombre, contraseña));
		return p;
	}
	...
	public Usuario setUsuario(@RequestParam Integer id, String nombre, String contraseña) {
		Usuario p = pp.save(new Usuario(id, nombre, contraseña));
		return p;
	}
